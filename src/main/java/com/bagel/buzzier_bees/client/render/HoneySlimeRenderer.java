...
public class HoneySlimeRenderer extends MobRenderer<HoneySlimeEntity, SlimeModel<HoneySlimeEntity>> {
   private static final ResourceLocation HONEY_SLIME_TEXTURES = new ResourceLocation("buzzier_bees:textures/entity/honey_slime.png");
   private static final ResourceLocation DESTICKED_HONEY_SLIME_TEXTURES = new ResourceLocation("buzzier_bees:textures/entity/honey_slime_bottled.png");

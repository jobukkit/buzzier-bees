...
import com.bagel.buzzier_bees.common.blocks.CandleBlock;
import com.bagel.buzzier_bees.common.blocks.CartwheelBlock;
import com.bagel.buzzier_bees.common.blocks.CompatFlowerPotBlock;
import com.bagel.buzzier_bees.common.blocks.CompatHangingFlowerPotBlock;
import com.bagel.buzzier_bees.common.blocks.CrystallizedHoneyBlock;
import com.bagel.buzzier_bees.common.blocks.HangingFlowerPotBlock;
import com.bagel.buzzier_bees.common.blocks.HoneyLampBlock;
import com.bagel.buzzier_bees.common.blocks.HoneyPotBlock;
import com.bagel.buzzier_bees.common.blocks.PottedCartwheelBlock;
import com.bagel.buzzier_bees.common.blocks.ScentedCandleBlock;
import com.bagel.buzzier_bees.core.BuzzierBees;
import com.bagel.buzzier_bees.core.util.CompatBlocks;
import com.bagel.buzzier_bees.core.util.PropertyUtils;
...
{	
	...
	public static final RegistryObject<Block> HONEY_BRICKS              = HELPER.createBlock("honeycomb_bricks", () -> new Block(Block.Properties.from(Blocks.BRICKS)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> HONEY_BRICK_STAIRS 	    = HELPER.createBlock("honeycomb_brick_stairs", () -> new AbnormalsStairsBlock(HONEY_BRICKS.get().getDefaultState(), Block.Properties.from(Blocks.BRICK_STAIRS)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> HONEY_BRICK_SLAB 	        = HELPER.createBlock("honeycomb_brick_slab", () -> new SlabBlock(Block.Properties.from(Blocks.BRICK_SLAB)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> HONEY_BRICK_WALL 	        = HELPER.createBlock("honeycomb_brick_wall", () -> new WallBlock(Block.Properties.from(Blocks.BRICK_WALL)), ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> HONEY_BRICK_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "honeycomb_brick_vertical_slab", () -> new VerticalSlabBlock(Block.Properties.from(HONEY_BRICKS.get())), ItemGroup.BUILDING_BLOCKS);

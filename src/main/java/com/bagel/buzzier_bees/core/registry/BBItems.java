...
import com.bagel.buzzier_bees.common.items.BeeBottleItem;
import com.bagel.buzzier_bees.common.items.BeeSoupItem;
import com.bagel.buzzier_bees.common.items.BugBottleItem;
import com.bagel.buzzier_bees.common.items.CuringItem;
import com.bagel.buzzier_bees.common.items.HoneyWandItem;
import com.bagel.buzzier_bees.common.items.StickyHoneyWandItem;
import com.bagel.buzzier_bees.core.BuzzierBees;
import com.bagel.buzzier_bees.core.other.BBFoods;
...
public class BBItems
{
	...
	public static final RegistryObject<Item> HONEY_SLIME_SPAWN_EGG 	= HELPER.createSpawnEggItem("honey_slime", () -> BBEntities.HONEY_SLIME.get(), 16361240, 16361300);
